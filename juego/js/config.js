...
const CONTROLS = [
  ...
  { key: 'L', action: 'Sonido de risa' },
  { key: 'K', action: 'Sonido desahuevate' },
  { key: 'V', action: 'Revivir a tu compañero' },
  { key: 'ESC', action: 'Volver a selección' },
  { key: 'Táctil', action: 'Toca IZQ para mover, DER para apuntar/atacar, Q/E/R habilidades, RISA y DESA' }
];
